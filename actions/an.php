<?php set_title('Akta Nokturna');
	...
	<ul id="an">
		...
		<ul>
			...
			<li><a href="<?php echo curi('archief/akta27.pdf'); ?>">Akta 27</a></li>
			<li><a href="<?php echo curi('archief/akta28.pdf'); ?>">Akta 28</a></li>
			<li><a href="<?php echo curi('archief/akta29.pdf'); ?>">Akta 29</a></li>
			<li><a href="<?php echo curi('archief/akta30.pdf'); ?>">Akta 30</a></li>
		</ul>
		<li>Jaargang 7</li>
		<ul>
			<li><a href="<?php echo curi('archief/akta20.pdf'); ?>">(Intro) Akta 20</a></li>
			<li><a href="<?php echo curi('archief/akta21.pdf'); ?>">Akta 21</a></li>
			<li><a href="<?php echo curi('archief/akta22.pdf'); ?>">Akta 22</a></li>
			<li><a href="<?php echo curi('archief/akta23.pdf'); ?>">Akta 23</a></li>
			<li><a href="<?php echo curi('archief/akta24.pdf'); ?>">Akta 24</a></li>
		</ul>
		<li>Jaargang 6</li>
		<ul>
			<li><a href="<?php echo curi('archief/akta16.pdf'); ?>">(Intro) Akta 16</a></li>
			<li><a href="<?php echo curi('archief/akta17.pdf'); ?>">Akta 17</a></li>
			<li><a href="<?php echo curi('archief/akta18.pdf'); ?>">Akta 18</a></li>
			<li><a href="<?php echo curi('archief/akta19.pdf'); ?>">Akta 19</a></li>
		</ul>
		<li>Jaargang 5</li>
		<ul>
