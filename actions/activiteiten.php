<?php set_title('Activiteiten');
	  default_header(); ?>
<img src="<?php echo curi('img/posters2.jpg'); ?>" />
...
<a href="<?php echo auri('route'); ?>">Villa van Schaeck</a>.  Wil je concrete 
up-to-date informatie over ons programma? Kijk even in
onze <a href="<?php echo auri('agenda') ?>">agenda</a>.</p>
<?php default_footer(); ?>
